...
class LinkmanActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title.textResource = R.string.linkman
        ...
        doAsync {
            ...
            val strings = content_data!!.userword[1].words
                                        ...
                                        override fun invoke(v: View?, word: String) {
                                            when (v?.id) {
                                                ...
                                                R.id.bt_item_update -> {
                                                    ...
                                                    rvContent.adapter.notifyDataSetChanged()
                                                    itemdialog?.dismiss()
                                                    Snackbar.make(rootView, "修改成功", Snackbar.LENGTH_SHORT).show()
                                                }
                                            }
                                        }
                                    }, this@LinkmanActivity)
    ...
    override fun onStop() {
        ...
        content_data!!.userword[1].words = strs
